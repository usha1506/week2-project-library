...
const filter21stCenturyButton = document.getElementById(
  "filter21stCenturyButton"
);
...
const loadBooks = (booksArray) => {
  ...
  booksArray.forEach((book) => {
    ...
    <div class="card">
      ...
      <p><img src=${book.image} art=${book.title}></p>
...
mystery.addEventListener("click", () => {
  // I assume you meant to use "mystery" instead of "mysteryFiction"
...
function filterBooksFrom21stCentury(booksArray) {
  ...
  return booksArray.filter(
    (book) => book.year >= 2000 && book.year <= currentYear
  );
}
document
  .getElementById("filter21stCenturyButton")
...
document
  .getElementById("sortRatingDescendingButton")
  .addEventListener("click", sortBooksByRatingDescending);
...
// Attach click event listeners to buttons for sorting by rating.
document
  .getElementById("sortRatingAscendingButton")
  .addEventListener("click", sortBooksByRatingAscending);
...
document
  .getElementById("sortByAlphaAscButton")
  .addEventListener("click", sortBooksAscending);
